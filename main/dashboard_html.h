...
"</td></tr>"
"<tr><td>SRP Server (Thread DNS-SD)<br><span style='font-size:.8em;color:#666'>"
"ON = local DNS-SD service discovery for Thread mesh (binding works without external TBR).<br>"
"OFF = requires external TBR (e.g. Google Nest) for device address resolution (default).</span></td>"
